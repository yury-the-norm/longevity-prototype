...
// ── Screen wrapper style — fills parent completely ──────────────────────
...
function MobileApp({ onBack, annotationsVisible }) {
  ...
  const handleTab = (tab) => {
    setNavTab(tab)
    const map = { overview: 'dashboard', data: 'metric-details', plan: 'dashboard', profile: 'subscription' }
...
export default function App() {
  ...
  const shellMode = stage === 'mobile' ? 'phone'
                  : stage === 'tablet' ? 'tablet'
                  : 'fullscreen'
